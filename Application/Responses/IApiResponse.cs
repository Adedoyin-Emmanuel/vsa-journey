...
public interface IApiResponse
{
    ...
    object BadRequest(string requestId, object? errors, string? message = "Invalid request" );
    ...
    object InternalServerError(string requestId, object ? errors, string? message = "An unknown error occurred");
}