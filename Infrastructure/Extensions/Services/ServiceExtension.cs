...
public static class ServiceExtension
{
    ...
    public static void AddCustomAuthentication(IServiceCollection services)
    {
    ...
    public static void AddPersistence(IServiceCollection services)
    {
    ...
    public static void AddCustomLogging(this HostBuilder hostBuilder)
    {
